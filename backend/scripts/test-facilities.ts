...
async function runTests() {
  ...
  const totalCount = db.prepare(`SELECT COUNT(*) as total FROM facilities`).get() as any;
  console.log('----------------------------------------');
